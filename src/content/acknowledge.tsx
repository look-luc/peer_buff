    ...
    return(
        <div className='wrapper'>
            ...
            <div className='acknowledge'>
                ...
                <p className='statement'>
                    The logo of Peer Buff has been made possible by the talented artist Roman Norquest from Delaware.  If you want to see more art work, take a look at their art instagram @meow_ghostt
                </p>
            </div>
        </div>
    )
